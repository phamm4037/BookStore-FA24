...
public class CartFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        // CHỈ kiểm tra đã đăng nhập chưa, KHÔNG kiểm tra role
        if(session.getAttribute(CommonConst.SESSION_ACCOUNT) == null){
            resp.sendRedirect(req.getContextPath() + "/authen?action=login");
            return;
        }
        
        // Đã login rồi thì cho qua, không quan tâm role
