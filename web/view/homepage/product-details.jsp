...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="offcanvas__content">
                        <div class="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                            <div class="offcanvas__logo">
                                <a href="index.html">
                                    <img src="${pageContext.request.contextPath}/img/logo/black-logo.svg" alt="logo-img">
                                </a>
                            </div>
                        ...
                        <div class="identityBox">
                            ...
                            <div class="banner">
                                ...
                                <button type="button" class="theme-btn rounded-0 register-btn" data-bs-toggle="modal"
                                    ...
                                    Account</button>
                                <div class="signUpBg">
                                    <img src="${pageContext.request.contextPath}/img/registrationbg.jpg" alt="signUpBg">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="breadcrumb-wrapper">
            <div class="book1">
                <img src="${pageContext.request.contextPath}/img/hero/book1.png" alt="book">
            </div>
            <div class="book2">
                <img src="${pageContext.request.contextPath}/img/hero/book2.png" alt="book">
            </div>
            <div class="container">
        ...
        <footer class="footer-section footer-bg">
            ...
            <div class="footer-widgets-wrapper">
                <div class="plane-shape float-bob-y">
                    <img src="${pageContext.request.contextPath}/img/plane-shape.png" alt="img">
                </div>
                <div class="container">
                    <div class="row">
                ...
                <div class="container">
                    <div class="footer-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <ul class="brand-logo wow fadeInRight" data-wow-delay=".5s">
                            <li>
                                <a href="contact.html">
                                    <img src="${pageContext.request.contextPath}/img/visa-logo.png" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="contact.html">
                                    <img src="${pageContext.request.contextPath}/img/mastercard.png" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="contact.html">
                                    <img src="${pageContext.request.contextPath}/img/payoneer.png" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="contact.html">
                                    <img src="${pageContext.request.contextPath}/img/affirm.png" alt="img">
                                </a>
                            </li>
                        </ul>
                    </div>
