...
<body>
    ...
    <jsp:include page="common/Sticky Header.jsp"></jsp:include>

    <!-- Main Header Section start  -->
    <jsp:include page="common/Main Header Section.jsp"></jsp:include>

     <!-- Login Modal -->
    <jsp:include page="common/Login Modal.jsp"></jsp:include>
    
    <!-- Registration Modal -->
    <jsp:include page="common/Registration Modal.jsp"></jsp:include>

    <!-- Breadcumb Section Start -->
    <jsp:include page="common/Breadcumb Section.jsp"></jsp:include>
    <!-- Shop Section Start -->
                            ...
                            <div class="tab-pane fade show active" id="pills-arts" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="shop-details.html"><img src="${pageContext.request.contextPath}/img/book/01.png" alt="img"></a>
                                                <ul class="post-box">
                                                    <li>
                                                        Hot
                                                    </li>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="shop-details-2.html"><img src="${pageContext.request.contextPath}/img/book/06.png" alt="img"></a>
                                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                                    <li>
                                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                                    </li>
    ...
    <jsp:include page="common/Footer Section.jsp"></jsp:include>
