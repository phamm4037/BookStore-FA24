<%-- 
    ...
    Created on : Oct 27, 2025, 4:03:32 PM
    Author     : phamm
--%>
            ...
            <div class="modal-body">
                <form id="addProductForm" action="product?action=add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nameInput" name="author">
                        <div id="nameError" class="error"></div>
                    </div>
                    <!--publisher-->
                    <div class="form-group">
                        <label for="publisher">Publisher:</label>
                        <input type="text" class="form-control" id="nameInput" name="publisher">
                        <div id="nameError" class="error"></div>
                    </div>
                    <!--publication Year-->
                    <div class="form-group">
                        <label for="publication_year">Publication Year:</label>
                        <input type="text" class="form-control" id="nameInput" name="publication_year">
                        <div id="nameError" class="error"></div>
                    </div>
                    <!--Price-->
                    <div class="form-group">
