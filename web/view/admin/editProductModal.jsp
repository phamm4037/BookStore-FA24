<%-- 
    ...
    Created on : Oct 27, 2025, 7:19:54 PM
    Author     : phamm
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editBookForm" action="product?action=edit" method="POST" enctype="multipart/form-data">
                    ...
                    <!--publication_year-->
                    <div class="form-group">
                        <label for="publication_year">Author:</label>
                        <input type="text" class="form-control" id="publication_yearEditInput" name="publication_year">
                        <div id="authorEditError" class="error"></div>
                    </div>
                    <!--Price-->
                    <div class="form-group">
...
<script>
    ...
    function editProductModal(button) {
        ...
        let publication_year = $(button).closest('tr').find('td[name="publication_year"]').text().trim();
        let price = $(button).closest('tr').find('td[name="price"]').text().trim().split('$')[0];
        console.log(price);
        let quantity = $(button).closest('tr').find('td[name="stock_quantity"]').text().trim();
